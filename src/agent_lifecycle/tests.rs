...
mod tests {
    ...
    fn test_extract_agent_from_branch() {
        ...
        assert_eq!(
            extract_agent_from_branch("agent001/123-fix-clambake-land"),
            "agent001"
        );
        assert_eq!(
            extract_agent_from_branch("agent003/789-implement-feature"),
            "agent003"
        );
    ...
    fn test_integration_scenario() {
        ...
        executor
            .git
            .set_commits_ahead("main", vec!["abc123: Implement feature".to_string()]);
