    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
                ...
                match octocrab_err {
                    octocrab::Error::GitHub { source, .. } => {
                        ...
                        match source.status_code.as_u16() {
                            ...
                            _ => {
                                ...
                                writeln!(
                                    f,
                                    "   → Test connection: curl -I https://api.github.com"
                                )?;
                    ...
                    octocrab::Error::Http { .. } => {
                        ...
                        if is_ci {
                            ...
                            writeln!(
                                f,
                                "   → Verify GitHub API status: https://status.github.com"
                            )?;
                            ...
                            writeln!(
                                f,
                                "   → Test basic connectivity: curl -I https://api.github.com"
                            )?;
                        } else {
                            ...
                            writeln!(
                                f,
                                "   → Step 2: Test DNS resolution: nslookup api.github.com"
                            )?;
                            ...
                            writeln!(
                                f,
                                "   → Add GitHub to allowlist: api.github.com, github.com"
                            )?;
            ...
            GitHubError::RateLimit {
                ...
                writeln!(
                    f,
                    "⏱️  Rate limit exceeded. {} requests remaining",
                    remaining
                )?;
                ...
                if wait_minutes <= 60 {
                    ...
                    writeln!(
                        f,
                        "   → Wait ~{} hours for automatic reset",
                        (wait_minutes + 30) / 60
                    )?;
                }
            ...
            GitHubError::NetworkError(msg) => {
                ...
                if is_ci {
                    ...
                    writeln!(
                        f,
                        "   → Test: curl -v --proxy $HTTP_PROXY https://api.github.com"
                    )?;
                } else {
            ...
            GitHubError::TokenScopeInsufficient {
                ...
                writeln!(
                    f,
                    "      → export MY_LITTLE_SODA_GITHUB_TOKEN=your_new_token"
                )?;
                writeln!(f)?;
                ...
                write!(
                    f,
                    "   → 'pull_requests:write' = Create and modify pull requests"
                )
            }
        }
    }
