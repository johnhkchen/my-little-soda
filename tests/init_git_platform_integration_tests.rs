...
async fn test_init_with_github_https_remote() {
    ...
    assert!(
        result.is_ok(),
        "Init should handle GitHub HTTPS remote: {:?}",
        result.err()
    );
...
async fn test_init_with_github_ssh_remote() {
    ...
    assert!(
        result.is_ok(),
        "Init should handle GitHub SSH remote: {:?}",
        result.err()
    );
...
async fn test_init_with_bitbucket_ssh_remote() {
    ...
    std::process::Command::new("git")
        .args([
            ...
            "add",
            "origin",
            "git@bitbucket.org:test-owner/test-repo.git",
        ])
        .output()
...
async fn test_init_with_custom_port_ssh_remote() {
    ...
    std::process::Command::new("git")
        .args([
            ...
            "add",
            "origin",
            "ssh://git@gitlab.com:2222/test-owner/test-repo.git",
        ])
        .output()
...
async fn test_init_with_multiple_remotes() {
    ...
    std::process::Command::new("git")
        .args([
            ...
            "add",
            "fork",
            "git@github.com:fork-owner/test-repo.git",
        ])
        .output()
    ...
    assert!(
        result.is_ok(),
        "Init should handle multiple remotes: {:?}",
        result.err()
    );
...
async fn test_init_with_no_remote() {
    ...
    assert!(
        result.is_err(),
        "Init should fail for repos without remotes"
    );
...
async fn test_init_with_malformed_remote_urls() {
    ...
    for url in malformed_urls {
        ...
        assert!(
            result.is_err(),
            "Init should fail for malformed URL: {}",
            url
        );
