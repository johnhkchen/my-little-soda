...
impl CliTestEnvironment {
    ...
    pub fn create_agent_branch(
        ...
        write(
            ...
            format!("Work for issue {}", issue_number),
        )?;
...
mod tests {
    ...
    fn test_clambake_pop_no_work() {
        ...
        cmd.current_dir(env.repo_path())
            ...
            .stdout(
                predicate::str::contains("No available tasks")
                    .or(predicate::str::contains("Searching for available tasks")),
            );
    }
    ...
    fn test_clambake_peek_command() {
        ...
        cmd.current_dir(env.repo_path())
            ...
            .success()
            .stdout(
                predicate::str::contains("Next available task")
                    .or(predicate::str::contains("No tasks available")),
            );
    }
        ...
        cmd.current_dir(env.repo_path())
            ...
            .stderr(predicate::str::contains("is not an agent branch").or(
                predicate::str::contains(
                    "Expected format: agent001/123 or agent001/123-description",
                ),
            ));
    }
    ...
    fn test_clambake_bundle_with_mock_branches() {
        ...
        env.create_agent_branch(123, "Fix authentication bug")
            .unwrap();
        ...
        cmd.current_dir(env.repo_path())
            ...
            .stdout(
                predicate::str::contains("bundle")
                    .or(predicate::str::contains("Bundle").or(predicate::str::contains("queued"))),
            );
    }
    ...
    fn test_clambake_missing_git_repo() {
        ...
        cmd.current_dir(temp_dir.path())
            ...
            .stderr(predicate::str::contains("git").or(
                predicate::str::contains("repository").or(predicate::str::contains("not found")),
            ));
    }
    ...
    fn test_clambake_concurrent_bundler_prevention() {
        ...
        cmd.current_dir(env.repo_path())
            ...
            .stdout(
                predicate::str::contains("bundler")
                    .or(predicate::str::contains("running").or(predicate::str::contains("lock")))
                    .or(predicate::str::is_empty()),
            );
    }
    ...
    async fn test_clambake_async_operations() {
        ...
        for i in 0..3 {
            ...
            let handle = tokio::spawn(async move {
                ...
                let result = cmd.current_dir(&repo_path).arg("peek").output();
